                        ...
                        <v-card-text class="accreditation-form__body">
                            <v-layout row wrap>
                                ...
                                <v-flex xs6 class="mt-2">
                                    <component
                                            :is="fields['Капитал'].fieldType"
                                            label="Capital of a Fund (USD)"
                                            ref="Капитал"
                                            :field="fields['Капитал']"
                                            :inputData.sync="formData['Капитал']"
                                            :allData="formData"
                                            suffix="$"
                                    ></component>
                                </v-flex>
...
<script>
    ...
    const modelName = 'Заявка на аккредитацию инвестиционного фонда';
    const processName = 'Подать заявку на аккредитацию инвестиционного фонда';
